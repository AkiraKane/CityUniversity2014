...
plt.show()
# Dual Plot
plt.scatter(Passenger_Data1.Age, Passenger_Data1.Fare, c='g')
plt.scatter(Passenger_Data.Age, Passenger_Data.Fare, c='r')
plt.show()
...
Subset = Car_Data[['price','mileage']]
Subset.mean()

def MahalanobisScore(x):
    cdist(x, Subset.mean(), 'mahalanobis', VI=None)

Car_Data['MahalanobisScore'] = Subset.apply(MahalanobisScore, axis=1)
#############################
