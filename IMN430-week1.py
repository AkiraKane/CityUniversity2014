...
# Basic mathematical operations can be done on the console in Python. Python acts here like an interpreter.
...
# Loops are a common method to run a particular task several times, they are central in all modern programming languages. range() is a function that returns a series of items that you can iterate on. Try Ctrl+I on range to see what it does.
