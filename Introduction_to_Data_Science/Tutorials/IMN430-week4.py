...
passenger = pd.read_csv(
    'http://staff.city.ac.uk/~sbbk529/Teaching/Resources/INM430/censusCrimeClean.csv')
...
# and comment on the results. Note that you first model and fit the model
# to your data:
...
# RentMedian: rental housing - median rent (Census variable H32B from file
# STF1A) (numeric - decimal)
Subset_2 = sorted(passenger.as_matrix(['RentMedian']))
