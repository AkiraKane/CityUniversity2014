...
def logisticRegression(trainingRDD, trainingRDDHashed, testRDDHashed):
    ...
    trainedModel = LogisticRegressionWithSGD.train(trainingRDD, iterations=100, miniBatchFraction=0.175, regType="l2", intercept=True, regParam=1.0, step=0.125)
    # Test on Validation and Test Sets
...
if __name__ == "__main__":
    ...
    directory = ['/data/extra/gutenberg/text-full'             \
    ...
    if len(getDirectory(directory[9])) == 1:
        ...
        for hashsize in hashsizeVec:
            ...
            for i in np.arange(0,10):
                ...
                resultList.append([hashsize, i+1, 1, 1, AccuracyV, fScoreV, AccuracyT, fScoreT, time() - timeIt])
                ...
                resultList.append([hashsize, i+1, 1, 2, AccuracyV, fScoreV, AccuracyT, fScoreT, time() - timeIt])
                ...
                resultList.append([hashsize, i+1, 1, 3, AccuracyV, fScoreV, AccuracyT, fScoreT, time() - timeIt])
    # Stop Watch
