            ...
            for i in np.arange(0, 1):
                ...
                for k in np.arange(1, 2):
                    ...
                    for j in np.arange(0, 1):
                        iterations = iterSize[j]
                        # Change in minibatch Size
                        batches = [
                            0.3,
                            0.25,
                            0.225,
                        ...
                        for l in np.arange(0, 10):
                            minibatch = batches[l]
                            # Step Size
                            sizes = [0.2, 0.125, 0.1, 0.01]
                            for p in np.arange(0, 4):
                                stepsize = sizes[p]
                                # Copy the Hashed RDD
                                modelSet = tf_idf
                                # Create List for filtering the Data
                                trainingList, testList = getSetList(
                                    ebookNumbers)
                                # Create Sets of data into the correct
                                # format...
                                ...
                                try:
                                    ...
                                    AccuracyV, fScoreV, AccuracyT, fScoreT = logisticRegression(
                                        trainingRDD, trainingRDDHashed, testRDDHashed, iterations, minibatch, stepsize)
