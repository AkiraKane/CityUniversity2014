...
def processXML(table):
    ...
    df.to_csv('/home/dan/Desktop/IMN432-CW01/Top_10_Subjects.csv', sep=',')
...
if __name__ == "__main__":
    ...
    directory = [
        '/home/dan/Desktop/IMN432-CW01/text-part/',
    ...
    df.to_csv(
        '/home/dan/Desktop/IMN432-CW01/Results' +
        str(hashsize) +
        '.csv',
        sep=',')
