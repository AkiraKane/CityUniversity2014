...
train <- fread("/home/dan/Desktop/CityUniversity2014/Machine_Learning/Rossmann_Store_Sales/train.csv",stringsAsFactors = T)
test  <- fread("/home/dan/Desktop/CityUniversity2014/Machine_Learning/Rossmann_Store_Sales/test.csv",stringsAsFactors = T)
store <- fread("/home/dan/Desktop/CityUniversity2014/Machine_Learning/Rossmann_Store_Sales/store.csv",stringsAsFactors = T)
